...
async def scenario_1_price_discovery():
    """Scenario 1: Price Discovery with a single seller and multiple buyers."""
    ...
    agent_configs = [
        ...
        # Buyer Agents
        {'utility_per_mhz': 10.0, "need_schedule": [100] * SIMULATION_TICKS, "need_volatility": 0},
        {'utility_per_mhz': 15.0, "need_schedule": [100] * SIMULATION_TICKS, "need_volatility": 0},
    ...
    #scenario_name_second_price = "scenario_1_price_discovery_second_price"
    ...
    # --- First-Price Auction ---
    scenario_name_first_price = "scenario_1_price_discovery_first_price"
    ...
    # --- Direct Sale Auction ---
    scenario_name_direct_sale = "scenario_1_price_discovery_direct_sale"
...
if __name__ == "__main__":
    ...
    print("--- Running Scenario 1: Price Discovery ---")
    asyncio.run(scenario_1_price_discovery())